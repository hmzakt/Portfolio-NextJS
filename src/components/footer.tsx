...
function Footer() {
  ...
  <div className="flex gap-4">
    <a href="https://github.com/hmzakt" target="_blank" rel="noopener noreferrer">
      <img src="/svgs/gh.svg" alt="GitHub" className="w-10 h-10 hover:opacity-80 transition" />
    </a>
    <a href="https://www.linkedin.com/in/hmzakt/" target="_blank" rel="noopener noreferrer">
      <img src="/svgs/linkedin.svg" alt="LinkedIn" className="w-10 h-10 hover:opacity-80 transition" />
    </a>
    <a href="mailto:hmzakt11@gmail.com">
      <img src="/svgs/gmail.svg" alt="Email" className="w-10 h-10 hover:opacity-80 transition" />
    </a>
  </div>
</footer>
